...
public class MascotaporClienteDao implements IClientepormascota {
    ...
    @Override
    public boolean guardarClientepormascota(Clientepormascota mascotaporcliente) {
    ...
    @Override
    public boolean actualizarClientepormascota(Clientepormascota mascotaporcliente) {
    ...
    @Override
    public boolean eliminarClientepormascota(Clientepormascota mascotaporcliente) {
        Session sesion = null;
        boolean resp = true;
        try {
